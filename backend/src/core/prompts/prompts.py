...
ILLUSTRATION_STYLE_ATTRIBUTES = [
    ...
    {
        "style_id": "marcia_brown_woodcut",
        "style_display_name": "storybook woodcut illustration",
        "style_brief": "Render the image in a Marcia Brown-inspired woodcut style with bold carved linework, flattened medieval compositions, and hand-colored shapes that retain the graphic strength of the cut block.",
        "must_have_visual_traits": [
            "bold carved linework with visible variation and slight irregularity",
            "flat hand-colored areas contained within strong black outlines",
            "decorative medieval-inspired shapes in clothing, architecture, and borders",
            "compressed spatial depth with stacked or tilted planes",
        ],
        "must_not_have_visual_traits": [
            "soft painterly blending or realistic shading",
            "clean digital vector precision",
            "loose sketchy pencil underdrawing",
            "modern graphic minimalism or glossy rendering",
        ],
        "visual_anchor_cues": [
            "linework feels carved rather than drawn, with slight roughness and rhythm",
            "figures and environments read as patterned shapes rather than volumetric forms",
            "backgrounds often include decorative motifs or simplified scenic elements",
        ],
        "immutable_attributes": [
            "woodcut-style carved line construction",
            "flat color fills paired with strong black line",
            "decorative medieval visual language",
            "shape-driven rather than volumetric rendering",
        ],
        "flexible_attributes": [
            "composition can range from dense narrative scenes to simpler vignettes",
            "ornamental detail can increase around borders or focal elements",
            "color palette can shift while remaining flat and graphic",
        ],
        "Dimensionality/Depth": "Flattened, layered depth with minimal perspective",
        "Color Palette": "Limited, slightly muted hand-applied colors",
        "Line Quality": "Bold, irregular carved lines with strong graphic presence",
        "Texture": "Woodcut grain and ink irregularities",
        "Character Style": "Stylized, folkloric, slightly rigid figures",
        "Perspective": "Medieval flattened space with stacked elements",
        "Movement": "Stiff but expressive through pose and gesture",
        "Composition": "Decorative, narrative-driven with strong shape framing",
        "Use of Space": "Filled with pattern and symbolic detail rather than open realism",
        "Lighting": "Minimal; form defined by line and flat color contrast",
        "Mood/Atmosphere": "Folkloric, historic, decorative",
        "Medium": "Woodcut print with hand coloring",
        "Detail Level": "Moderate with emphasis on pattern and line rhythm",
    },
    {
        "style_id": "hogrogian_folk_ink_wash",
        "style_display_name": "folk ink wash",
        "style_brief": "Loose brush-and-ink line with warm limited washes and simplified folk figures.",
        "must_have_visual_traits": [
            "brushy ink lines with visible variation",
            "limited warm or near-monochrome palette",
            "flat or lightly washed shapes",
            "simplified folk-style figures and animals",
        ],
        "must_not_have_visual_traits": [
            "clean vector or polished linework",
            "bright full-color rendering",
            "realistic anatomy or deep perspective",
            "dense painterly texture",
        ],
        "visual_anchor_cues": [
            "tapered brush lines showing pressure",
            "decorative, non-realistic figures",
            "sparse or lightly suggested backgrounds",
        ],
        "immutable_attributes": [
            "brush-and-ink linework",
            "limited warm palette",
            "folk simplification",
            "economical rendering",
        ],
        "flexible_attributes": [
            "composition density can vary",
            "wash intensity can shift",
            "decorative detail can expand",
        ],
        "Dimensionality/Depth": "Mostly flat with slight overlap depth",
        "Color Palette": "Warm limited tones or near-monochrome",
        "Line Quality": "Loose, varied brush lines",
        "Texture": "Ink bleed and light wash",
        "Character Style": "Simplified, folk, expressive",
        "Perspective": "Minimal, flattened",
        "Movement": "Lively through gesture",
        "Composition": "Open, character-focused",
        "Use of Space": "Generous negative space",
        "Lighting": "Minimal wash-based tone",
        "Mood/Atmosphere": "Warm, folkloric, intimate",
        "Medium": "Ink and wash",
        "Detail Level": "Simple to moderate",
    },
    {
        "style_id": "van_gogh_starry_night",
        "style_display_name": "expressive impasto swirl",
        "style_brief": "Thick, swirling brushwork with luminous color and rhythmic movement.",
        "must_have_visual_traits": [
            "visible impasto with thick directional strokes",
            "swirling, rhythmic motion in sky and forms",
            "high-contrast complementary colors (blues, yellows)",
            "glowing halos around stars and light sources",
        ],
        "must_not_have_visual_traits": [
            "smooth blended gradients",
            "flat graphic color blocking",
            "fine linear detail or ink outlines",
            "photorealistic rendering",
        ],
        "visual_anchor_cues": [
            "sky built from repeating curved stroke patterns",
            "light sources radiate with circular motion",
            "landscape simplified into bold painted masses",
        ],
        "immutable_attributes": [
            "thick impasto brushwork",
            "swirling directional strokes",
            "luminous contrasting color",
            "paint-driven form definition",
        ],
        "flexible_attributes": [
            "composition can shift while keeping motion emphasis",
            "color intensity can vary within a bold palette",
            "detail can concentrate in focal movement areas",
        ],
        "Dimensionality/Depth": "Shallow depth shaped by stroke direction",
        "Color Palette": "Bold blues, yellows, and high-contrast complements",
        "Line Quality": "Defined by brushstrokes rather than lines",
        "Texture": "Heavy impasto with visible stroke ridges",
        "Character Style": "Simplified forms",
        "Perspective": "Distorted, expressive",
        "Movement": "Continuous, swirling, rhythmic",
        "Composition": "Driven by motion and flow",
        "Use of Space": "Filled with active, moving marks",
        "Lighting": "Glowing, radiating highlights",
        "Mood/Atmosphere": "Emotional, turbulent, luminous",
        "Medium": "Oil painting",
        "Detail Level": "Moderate with emphasis on texture and motion",
    },
]
