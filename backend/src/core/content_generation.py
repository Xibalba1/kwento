    ...
    try:
        ...
        generation_artifact["cover_generation"] = {
            **generation_artifact["cover_generation"],
            ...
            "generation_mode": cover_result.get("generation_mode"),
            "reference_image_count": cover_result.get("reference_image_count", 0),
            "tool_type": cover_result.get("tool_type"),
            "tool_action": cover_result.get("tool_action"),
            "input_fidelity": cover_result.get("input_fidelity"),
            "provider_response_id": cover_result.get("provider_response_id"),
