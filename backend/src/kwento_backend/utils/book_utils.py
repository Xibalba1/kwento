...
def book_title_normalize(input_string: str) -> str:
    """Normalize a string by removing non-alphanumeric characters, replacing whitespace with
    underscores, and appending the current datetime in YYYYMMDD_HHMMSS format.

    Args:
        input_string (str): The string to be normalized and appended with the datetime.

    Returns:
        str: The normalized string with the datetime appended.
